...
public class DebugHUD
{
    ...
    public void DrawGameObjecctsCounter(SpriteBatch spriteBatch)
    {
        ...
        Point leftTopPoint = (AppManager.Instance.SettingsManager.Resolution.ToVector2() * new Vector2(0.8f, 0.8f)).ToPoint();
        Point rightBottomPoint = (AppManager.Instance.SettingsManager.Resolution.ToVector2() * new Vector2(0.99f, 0.95f)).ToPoint();
